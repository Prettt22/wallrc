...
<html lang="id" data-bs-theme="dark">
  ...
  <body>
    ...
    <div class="container min-vh-100 my-3">
      <h2 class="mt-5 fw-bold text-center text-capitalize">Hasil Pencarian "<?= $_GET['search']; ?>"</h2>
      <hr>
    ...
    <script>
      function getWall() {
        ...
        axios
          .get("https://scenix-photo.000webhostapp.com/API/searchwall.php?search=" + search)
